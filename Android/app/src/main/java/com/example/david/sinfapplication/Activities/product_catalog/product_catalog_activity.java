...
public class product_catalog_activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        CartProduct[] dataset = {new CartProduct(new Product("PID","Core i7","This is shit",258,2569.48,"$"),5),new CartProduct(new Product("PID","AMD RX590","This is shit",258,2569.48,"$"),5)};
